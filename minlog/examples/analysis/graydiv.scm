;; 2025-11-07.  examples/analysis/graydiv.scm
...
(display "loading graydiv.scm ...") (newline)
...
;; [gb]
;;  (CoRec ag yprod boole=>ag ah yprod boole=>ah)gb
;;  ([gb0]
;;    [case gb0
;;      (ag pair b -> 
;;      [case (cCoGClosure ag)
...
;;          (b0 pair ag -> 
;;          [case b0
;;            (True -> [ag0]b pair InL cCoGIntNOne)
;;            (False -> [ag0]b pair InL(cCoGUMinus(cCoGCompat ag0)))]
;;          ag)])
;;        (InR ah -> InL(b pair InR(cCoHToCoG ah pair False)))])])
;;  ([hb]
;;    [case hb
;;      (ah pair b -> 
;;      [case (cCoHClosure ah)
...
;;          (b0 pair ag -> 
;;          [case b0
;;            (True -> [ag0]b pair InL cCoGOne)
;;            (False -> [ag0]b pair InL(cCoGUMinus(cCoGCompat ag0)))]
;;          ag)])
;;        (InR ah0 -> InL(b pair InR(cCoHToCoG ah0 pair True)))])])
...
;;               (InL bg -> 
;;               InL
;;               ([case bg (b0 pair ag -> b0)]pair[case bg (b0 pair ag -> ag)]))
;;               (InR ah -> InR ah)]
;;        (InL bg -> 
;;        InL
;;        [case bg
...
;; [ag]
;;  (CoRec ag yprod boole=>ag ah yprod boole=>ah)(ag pair True)
;;  ([gb]
;;    [case gb
;;      (ag0 pair b -> 
...
;; [ag]
;;  (CoRec ag yprod boole=>ag ah yprod boole=>ah)
;;  (cCoGUMinus(cCoGCompat ag)pair False)
;;  ([gb]
;;    [case gb
;;      (ag0 pair b -> 
;;      [case (cCoGClosure ag0)
...
;;      (b pair ag0 -> 
;;      [case b
;;        (True -> cCoGCompat(cCoGNegToCoGPlusOne(cCoGUMinus(cCoGCompat ag0))))
...
;;  [case [case (DesYprod ag)
;;           (InL bg -> 
;;           InL([case bg (b pair ag1 -> b)]pair[case bg (b pair ag1 -> ag1)]))
;;           (InR ah -> InR ah)]
;;    (InL bg -> 
;;    [case bg
;;      (b pair ag1 -> 
...
;;          (False -> SdL pair cCoGDivSatCoIClAuxL ag ag0)])])
;;      (InR ah0 -> 
;;      [case [case (DesYprod ah0)
;;               (InL bg -> 
;;               InL
;;               ([case bg (b pair ag1 -> b)]pair[case bg (b pair ag1 -> ag1)]))
;;               (InR ah -> InR ah)]
;;        (InL bg -> 
;;        [case bg
;;          (b pair ag1 -> 
...
;; [ag,ag0]
;;  (CoRec ag=>ag ah=>ah)ag0
;;  ([ag1]
;;    [case (cCoGDivSatCoICl ag1 ag)
;;      (s pair ag2 -> 
;;      [case (cSdDisj s)
;;        (DummyL -> InR(InR(cCoGToCoH ag2)))
;;        (Inr b -> InL(b pair InR(cCoGPsdTimes ag2(cPsdUMinus b))))])])
;;  ([ah]
;;    [case (cCoGDivSatCoICl(cCoHToCoG ah)ag)
;;      (s pair ag1 -> 
;;      [case (cSdDisj s)
;;        (DummyL -> InR(InR(cCoGToCoH ag1)))
;;        (Inr b -> InL(b pair InR(cCoGPsdTimes ag1 b)))])])

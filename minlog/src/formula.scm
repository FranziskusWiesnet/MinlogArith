	    ...
	    ((predconst-form? pred)
	     (cond ((string=? "Total" (predconst-to-name pred))
		   ...
		   ((string=? "CoEqP" (predconst-to-name pred))
		    (terms-to-pure-coeqp-formula (car args) (cadr args)))
		   ((string=? "CoEqPNc" (predconst-to-name pred))
		    (terms-to-pure-coeqpnc-formula (car args) (cadr args)))
		   ((string=? "EqPMR" (predconst-to-name pred))
		    (apply terms-to-pure-mr-coeqp-formula args))
		   ((string=? "CoEqPMR" (predconst-to-name pred))
		    (terms-to-pure-mr-coeqp-formula
...
(define formula-to-beta-pi-eta-nf beta-pi-eta-normalize-formula)
(define cterm-to-beta-pi-eta-nf beta-pi-eta-normalize-cterm)
(define bpe-nf beta-pi-eta-normalize-formula)

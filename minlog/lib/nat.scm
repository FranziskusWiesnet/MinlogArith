...
;; TotalNatSucc:	all nat^(TotalNat nat^ -> TotalNat(Succ nat^))
...
;; TotalNatToCoTotal
(set-goal "all n^(TotalNat n^ -> CoTotalNat n^)")
(assume "n^" "Tn")
(coind "Tn")
(assume "n^1" "Tn1")
...
;;  (CoRec nat=>nat)n
;;  ([n0]
;;    [if [if n0 (DummyL nat) (InrUysum nat)]
;;      (DummyL nat ysum nat)
;;      ([n1]Inr((InR nat nat)n1))])
...
;; TotalNatNcToCoTotalNc
(set-goal "all n^(TotalNatNc n^ -> CoTotalNatNc n^)")
(assume "n^" "Tn")
(coind "Tn")
(assume "n^1" "Tn1")
...
;; EfCoTotalNatNc
(set-goal "all n^(F -> CoTotalNatNc n^)")
(assume "n^" "Absurd")
(coind "Absurd")
(assume "n^1" "Useless")
(intro 0)
...
;; TotalNatMRToEqD
(set-goal "all n^1,n^2(TotalNatMR n^1 n^2 -> n^1 eqd n^2)")
...
;; TotalNatMRToTotalNcLeft
(set-goal "all n^1,n^2(TotalNatMR n^1 n^2 -> TotalNatNc n^1)")
...
;; TotalNatMRToTotalNcRight
(set-goal "all n^1,n^2(TotalNatMR n^1 n^2 -> TotalNatNc n^2)")
(assume "n^1" "n^2" "TMRHyp")
(elim "TMRHyp")
;; 3,4
(use "TotalNatNcZero")
...
;; TotalNatMRRefl
(set-goal "all n^(TotalNat n^ -> TotalNatMR n^ n^)")
(assume "n^" "TMRHyp")
(elim "TMRHyp")
;; 3,4
(use "TotalNatZeroMR")
...
;; EfCoTotalNatMR
(set-goal "all n^1,n^2(F -> CoTotalNatMR n^1 n^2)")
...
;; TotalNatMRToCoTotalMR
(set-goal "all n^1,n^2(TotalNatMR n^1 n^2 -> CoTotalNatMR n^1 n^2)")
...
;; EfEqPNat
(set-goal "all n^1,n^2(F -> EqPNat n^1 n^2)")
(assume "n^1" "n^2" "Absurd")
(simp (pf "n^1 eqd 0"))
(simp (pf "n^2 eqd 0"))
(use "EqPNatZero")
...
;; EfEqPNatNc
(set-goal "all n^1,n^2(F -> EqPNatNc n^1 n^2)")
(assume "n^1" "n^2" "Absurd")
(simp (pf "n^1 eqd 0"))
(simp (pf "n^2 eqd 0"))
(use "EqPNatNcZero")
...
;; EqPNatNcToEqD
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> n^1 eqd n^2)")
...
;; EqPNatSym
(set-goal "all n^1,n^2(EqPNat n^1 n^2 -> EqPNat n^2 n^1)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
(use "EqPNatZero")
...
;; EqPNatNcSym
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> EqPNatNc n^2 n^1)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
(use "EqPNatNcZero")
(assume "n^3" "n^4" "Useless" "EqPn4n3")
...
;; EqPNatRefl
(set-goal "all n^(TotalNat n^ -> EqPNat n^ n^)")
(assume "n^" "Tn")
(elim "Tn")
(use "EqPNatZero")
(assume "n^1" "Tn1")
...
;; EqPNatNcRefl
(set-goal "all n^(TotalNatNc n^ -> EqPNatNc n^ n^)")
(assume "n^" "Tn")
(elim "Tn")
(use "EqPNatNcZero")
...
;; EqPNatToTotalLeft
(set-goal "all n^1,n^2(EqPNat n^1 n^2 -> TotalNat n^1)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
;; 3,4
(use "TotalNatZero")
...
;; EqPNatNcToTotalNcLeft
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> TotalNatNc n^1)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
;; 3,4
(use "TotalNatNcZero")
...
;; EqPNatToTotalRight
(set-goal "all n^1,n^2(EqPNat n^1 n^2 -> TotalNat n^2)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
;; 3,4
(use "TotalNatZero")
...
;; EqPNatNcToTotalNcRight
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> TotalNatNc n^2)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
;; 3,4
(use "TotalNatNcZero")
...
;; EqPNatNcTrans
(set-goal
 "all n^1,n^2,n^3(EqPNatNc n^1 n^2 -> EqPNatNc n^2 n^3 -> EqPNatNc n^1 n^3)")
...
;; EqPNatNcToEq
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> n^1=n^2)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
(use "Truth")
...
;; EqNatToEqPNc
(set-goal "all n^1(TotalNatNc n^1 -> all n^2(TotalNatNc n^2 ->
...
;; EfCoEqPNat
(set-goal "all n^1,n^2(F -> CoEqPNat n^1 n^2)")
(assume "n^1" "n^2" "Absurd")
(coind "Absurd")
(assume "n^3" "n^4" "Useless")
(intro 0)
...
;; EfCoEqPNatNc
(set-goal "all n^1,n^2(F -> CoEqPNatNc n^1 n^2)")
(assume "n^1" "n^2" "Absurd")
(coind "Absurd")
(assume "n^3" "n^4" "Useless")
(intro 0)
...
;; CoEqPNatNcToEqD
(set-goal "all n^1,n^2(CoEqPNatNc n^1 n^2 -> n^1 eqd n^2)")
...
;; CoEqPNatSym
(set-goal "all n^1,n^2(CoEqPNat n^1 n^2 -> CoEqPNat n^2 n^1)")
...
;; CoEqPNatNcSym
(set-goal "all n^1,n^2(CoEqPNatNc n^1 n^2 -> CoEqPNatNc n^2 n^1)")
(assume "n^1" "n^2" "n1~n2")
(coind "n1~n2")
(assume "n^3" "n^4" "n4~n3")
(inst-with-to
...
;; CoEqPNatRefl
(set-goal "all n^(CoTotalNat n^ -> CoEqPNat n^ n^)")
(assert "all n^1,n^2(CoTotalNat n^1 andi n^1 eqd n^2 -> CoEqPNat n^1 n^2)")
(assume "n^1" "n^2")
(coind)
(assume "n^3" "n^4" "Conj")
...
;; CoEqPNatNcRefl
(set-goal "all n^(CoTotalNatNc n^ -> CoEqPNatNc n^ n^)")
(assert
 "all n^1,n^2(CoTotalNatNc n^1 andi n^1 eqd n^2 -> CoEqPNatNc n^1 n^2)")
(assume "n^1" "n^2")
(coind)
(assume "n^3" "n^4" "Conj")
(inst-with-to "Conj" 'left "CoTn3")
...
;; CoEqPNatToCoTotalLeft
(set-goal "all n^1,n^2(CoEqPNat n^1 n^2 -> CoTotalNat n^1)")
(assume "n^1" "n^2" "n1~n2")
...
;; CoEqPNatNcToCoTotalNcLeft
(set-goal "all n^1,n^2(CoEqPNatNc n^1 n^2 -> CoTotalNatNc n^1)")
(assume "n^1" "n^2" "n1~n2")
(use (imp-formulas-to-coind-proof
...
;; CoEqPNatToCoTotalRight
(set-goal "all n^1,n^2(CoEqPNat n^1 n^2 -> CoTotalNat n^2)")
(assume "n^1" "n^2" "n1~n2")
(use (imp-formulas-to-coind-proof
...
;; CoEqPNatNcToCoTotalNcRight
(set-goal "all n^1,n^2(CoEqPNatNc n^1 n^2 -> CoTotalNatNc n^2)")
(assume "n^1" "n^2" "n1~n2")
(use (imp-formulas-to-coind-proof
...
;; CoEqPNatNcTrans
(set-goal "all n^1,n^2,n^3(CoEqPNatNc n^1 n^2 -> CoEqPNatNc n^2 n^3 ->
                           CoEqPNatNc n^1 n^3)")
...
;; EqPNatToCoEqP
(set-goal "all n^1,n^2(EqPNat n^1 n^2 -> CoEqPNat n^1 n^2)")
(assume "n^1" "n^2" "EqPn1n2")
(coind "EqPn1n2")
...
;; EqPNatNcToCoEqPNc
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> CoEqPNatNc n^1 n^2)")
(assume "n^1" "n^2" "EqPn1n2")
(coind "EqPn1n2")
(assume "n^3" "n^4" "EqPn3n4")
(elim "EqPn3n4")
...
;; EfEqPNatMR
(set-goal "all n^1,n^2,n^3(F -> EqPNatMR n^1 n^2 n^3)")
...
;; EqPNatMRToEqDLeft
(set-goal "all n^1,n^2,n^3(EqPNatMR n^1 n^2 n^3 -> n^1 eqd n^2)")
...
;; EqPNatMRToEqDRight
(set-goal "all n^1,n^2,n^3(EqPNatMR n^1 n^2 n^3 -> n^2 eqd n^3)")
(assume "n^1" "n^2" "n^3" "EqPHyp")
(elim "EqPHyp")
(use "InitEqD")
(assume "n^4" "n^5" "n^6" "Useless" "EqDHyp")
...
;; EqPNatNcToTotalMR
(set-goal "all n^1,n^2(EqPNatNc n^1 n^2 -> TotalNatMR n^1 n^2)")
(assume "n^1" "n^2" "EqPn1n2")
(elim "EqPn1n2")
(use "TotalNatZeroMR")
(assume "n^3" "n^4" "Useless")
...
;; TotalNatMRToEqPNc
(set-goal "all n^1,n^2(TotalNatMR n^1 n^2 -> EqPNatNc n^1 n^2)")
(assume "n^1" "n^2" "TMRn1n2")
(elim "TMRn1n2")
(use "EqPNatNcZero")
(assume "n^3" "n^4" "Useless")
...
;; EqPNatMRToTotalNc
(set-goal "all n^1,n^2,n^3(EqPNatMR n^1 n^2 n^3 -> TotalNatNc n^3)")
(assume "n^1" "n^2" "n^3" "EqPHyp")
(elim "EqPHyp")
(use "TotalNatNcZero")
...
;; EqPNatMRRefl
(set-goal "all n^(TotalNatNc n^ -> EqPNatMR n^ n^ n^)")
(assume "n^" "Tn")
(elim "Tn")
(use "EqPNatZeroMR")
(assume "n^1" "IH")
...
;; EqPNatNcToEqPMR
(set-goal "all n^1,n^2,n^3(EqPNatNc n^1 n^2 -> EqPNatNc n^2 n^3 ->
...
;; EqPNatMRToEqPNcLeft
(set-goal "all n^1,n^2,n^3(EqPNatMR n^1 n^2 n^3 -> EqPNatNc n^1 n^2)")
...
;; EqPNatMRToEqPNcRight
(set-goal "all n^1,n^2,n^3(EqPNatMR n^1 n^2 n^3 -> EqPNatNc n^2 n^3)")
(assume "n^1" "n^2" "n^3" "EqPMRHyp")
(elim "EqPMRHyp")
(use "EqPNatNcZero")
...
;; EfCoEqPNatMR
(set-goal "all n^1,n^2,n^3(F -> CoEqPNatMR n^1 n^2 n^3)")
(assume "n^1" "n^2" "n^3" "Absurd")
(coind "Absurd")
(assume "n^4" "n^5" "n^6" "Useless")
(intro 0)
...
;; CoEqPNatNcToCoTotalMR
(set-goal "all n^1,n^2(CoEqPNatNc n^1 n^2 -> CoTotalNatMR n^1 n^2)")
(assume "n^1" "n^2" "n1~n2")
...
;; CoTotalNatMRToCoEqPNc
(set-goal "all n^1,n^2(CoTotalNatMR n^1 n^2 -> CoEqPNatNc n^1 n^2)")
...
;; CoEqPNatMRRefl
(set-goal "all n^(CoTotalNatNc n^ -> CoEqPNatMR n^ n^ n^)")
(assert
 "all n^1,n^2,n^3(CoTotalNatNc n^1 andnc n^1 eqd n^2 andnc n^2 eqd n^3 ->
...
;; CoEqPNatMRToCoEqPNcLeft
(set-goal "all n^1,n^2,n^3(CoEqPNatMR n^1 n^2 n^3 -> CoEqPNatNc n^1 n^2)")
...
;; CoEqPNatMRToCoEqPNcRight
(set-goal "all n^1,n^2,n^3(CoEqPNatMR n^1 n^2 n^3 -> CoEqPNatNc n^2 n^3)")
(assume "n^1" "n^2" "n^3" "CoEqPMRn1n2n3")
(use (imp-formulas-to-coind-proof
...
;; This concludes the properties of TotalNat and EqPNat.
...
(assert
 "all m^(TotalNat m^ -> all n^(TotalNat n^ -> TotalBoole(n^ <m^)))")
(fold-alltotal)
(ind)
;; 5,6
(fold-alltotal)
...
(assert
 "all m^(TotalNat m^ -> all n^(TotalNat n^ -> TotalNat(n^ max m^)))")
(fold-alltotal)
(ind)
;; 5,6
(fold-alltotal)
...
(assert
 "all m^(TotalNat m^ -> all n^(TotalNat n^ -> TotalNat(n^ min m^)))")
(fold-alltotal)
(ind)
;; 5,6
(fold-alltotal)
...
;; NatPlusEqP
(set-goal "all n^1,n^2(EqPNat n^1 n^2 -> all m^1,m^2(EqPNat m^1 m^2 ->
...
;; NatEqCompat
(set-goal "all n,m(n=m -> all ns(ns n=ns m))")
(ind)
  (cases)
    (assume "Useless" "ns")
    (use "Truth")
...
;; PredEqP
(set-goal "all n^,m^(EqPNat n^ m^ -> EqPNat(Pred n^)(Pred m^))")
(assume "n^" "m^" "EqPnm")
(elim "EqPnm")
;; 3,4
(use "EqPNatZero")
...
;; NatMaxEqP
(set-goal "all n^1,m^1(EqPNat n^1 m^1 -> all n^2,m^2(EqPNat n^2 m^2 ->
...
;; NatIfTotal
(set-goal "all n^(TotalNat n^ ->
 all alpha^,(nat=>alpha)^(Total alpha^ ->
 all m^(TotalNat m^ -> Total((nat=>alpha)^ m^)) ->
...
;; NatEqTotal
(set-goal "all n^(TotalNat n^ -> all m^(TotalNat m^ -> TotalBoole(n^ =m^)))")
(fold-alltotal)
(assume "n")
(fold-alltotal)
(assume "m")
...
;;      EqPNat n^ n^0 -> 
;;      all ws^,ws^0(
;;       all n^1,n^2(EqPNat n^1 n^2 -> EqPBoole(ws^ n^1)(ws^0 n^2)) -> 
...
;; AllBNatExtEqD
(set-goal "all n^(TotalNatNc n^ -> 
 all ws^,ws^0(
  all n^0(TotalNatNc n^0 -> ws^ n^0 eqd ws^0 n^0) ->
...
;;      TotalNatNc n^ -> 
;;      all ws^(
;;       all n^0(TotalNatNc n^0 -> TotalBooleNc(ws^ n^0)) -> 
...
;;      EqPNatNc n^ n^0 -> 
;;      all ws^,ws^0(
;;       all n^1,n^2(EqPNatNc n^1 n^2 -> EqPBooleNc(ws^ n^1)(ws^0 n^2)) -> 
...
;; AllBNatIntro
(set-goal "all ws,n(all n1(n1<n -> ws n1) -> AllBNat n ws)")
(assume  "ws")
(ind)
(strip)
(use "Truth")
...
;; AllBNatElim
(set-goal "all ws,n(AllBNat n ws -> all n1(n1<n -> ws n1))")
(assume  "ws")
(ind)
...
;; For efficiency reasons if is preferred over orb, since it computes
...
;; Code discarded 2025-09-14.  Now proved without ExBNatElim
;; ;; ExBNatToExNc
;; (set-goal "all ws,n(ExBNat n ws -> exnc m(m<n andnc ws m))")
...
;; Commented out 2025-09-14.  Proved already.
;; ;; ExNcToExBNat
;; (set-goal "all ws,n(exnc m(m<n andnc ws m) -> ExBNat n ws)")
;; (assume "ws" "n" "ExNcHyp")
...
;; NatNatTotalToExt
(set-goal "all ns,n^,n^0(EqPNat n^ n^0 -> EqPNat(ns n^)(ns n^0))")
(use
 "AllTotalIntro"
 (py "ns")
 (make-cterm
  (pv "ns^")
  (pf "all n^,n^0(EqPNat n^ n^0 -> EqPNat(ns^ n^)(ns^ n^0))"))
 "?")
...
;; NatNatTotalToExtNc
(set-goal "all ns,n^,n^0(EqPNatNc n^ n^0 -> EqPNatNc(ns n^)(ns n^0))")
(use-with
 "AllncTotalIntro"
 (py "ns")
 (make-cterm
  (pv "ns^")
  (pf "all n^,n^0(EqPNatNc n^ n^0 -> EqPNatNc(ns^ n^)(ns^ n^0))"))
 "?")
...
;; Code discarded 2025-09-13

;; ;; NatNatExtToTotalNc
;; (set-goal
;;  "all ns^(all n^,n^0(EqPNatNc n^ n^0 -> EqPNatNc(ns^ n^)(ns^ n^0)) ->
;;  all n^ TotalNatNc(ns^ n^))")
;; (assume "ns^" "nsExt" "n^")
...
(set-goal "all nat=>nat=>boole,n^,n^0(EqPNatNc n^ n^0 -> all n^1,n^2(
 EqPNatNc n^1 n^2 -> 
...
(use-with
 ...
 (make-cterm
  (pv "nat=>nat=>boole^")
  (pf "all n^,n^0(EqPNatNc n^ n^0 -> allnc n^1,n^2(EqPNatNc n^1 n^2 ->
       EqPBooleNc(nat=>nat=>boole^ n^ n^1)(nat=>nat=>boole^ n^0 n^2)))"))
 "?")
(assume "nat=>nat=>boole^" "Tf" "n^1" "n^2" "EqPn1n2" "n^3" "n^4" "EqPn3n4")
(inst-with-to "EqPNatNcToEqD" (pt "n^1") (pt "n^2") "EqPn1n2" "n1=n2")
...
(set-goal "all nat=>nat=>nat,n^,n^0(EqPNatNc n^ n^0 -> all n^1,n^2(
 EqPNatNc n^1 n^2 -> 
...
;;       TotalNatNc n^0 -> 
;;       all ws^(
;;        all n^1(TotalNatNc n^1 -> TotalBooleNc(ws^ n^1)) -> 
...
;;       EqPNatNc n^1 n^2 -> 
;;       all ws^,ws^0(
;;        all n^3,n^4(EqPNatNc n^3 n^4 -> EqPBooleNc(ws^ n^3)(ws^0 n^4)) -> 
...
;; monotonicity properties of NatLt which are proved later.
...
(pp "EqPNatNcSucc")
;; all n^,n^0(EqPNatNc n^ n^0 -> EqPNatNc(Succ n^)(Succ n^0))
...
;;        all n^1,n^2(
;;         EqPNatNc n^1 n^2 -> 
;;         all x^1,x^2(EqPNc x^1 x^2 -> EqPNc(f^ n^1 x^1)(f^0 n^2 x^2))) -> 
;;        EqPNc((Rec nat=>alpha)n^ x^ f^)((Rec nat=>alpha)n^0 x^0 f^0))))
...
;;        EqPNc[if n^ x^ xs^][if n^0 x^0 xs^0])))

(assert "all x^,x^0(
     EqPNc x^ x^0 -> 
     all (nat=>alpha)^,(nat=>alpha)^0(
      all n^,n^0(
...
;; Code discarded 2025-10-10: not needed
...
;; NatDoubleSuccHalfEven
(set-goal "all n(NatEven n -> NatDouble(Succ(NatHalf n))=Succ(Succ n))")
(assume "n")
(ng #t)
(use "NatDoubleHalfEven")
;; Proof finished.
;; (cp)
(save "NatDoubleSuccHalfEven")

;; NatNotEvenSuccDouble
(set-goal "all n(NatEven(Succ(NatDouble n)) -> F)")
(ind)
;; 2,3
(ng #t)
(assume "Absurd")
...
;;  (use "Prog")
;;  (use "IHn")
;; (assume "Assertion" "n") ;Warning: nc-intro with cvar(s) n9244 n9245
...
;; (RewriteGA0)
;; Where RewriteGA0 was created? Somewhere in list.scm?
...
;; We can strengthen NatHalfLe to

;; NatHalfSucc
(set-goal "all n NatHalf(Succ n)<=n")
(cases)
(use "Truth")
(assume "n")
(ng)
...
(remove-var-name "ml" "g" "gam" "f" "xs" "x" "k" "j" "i" "ij")

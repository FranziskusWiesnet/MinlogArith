...
;; EqPRatToTotalLeft
(set-goal "all a^,b^(EqPRat a^ b^ -> TotalRat a^)")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
;; 3
...
;; EqPRatToTotalRight
(set-goal "all a^,b^(EqPRat a^ b^ -> TotalRat b^)")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
;; 3
(assume "k^1" "k^2" "EqPk1k2" "p^1" "p^2" "EqPp1p2")
...
;; EqPRatToEqD
(set-goal "all a^,b^(EqPRat a^ b^ -> a^ eqd b^)")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
(assume "k^1" "k^2" "EqPk1k2" "p^1" "p^2" "EqPp1p2")
(simp (pf "k^1 eqd k^2"))
...
;; EqPRatToEqPRatNc
(set-goal "all a^,b^(EqPRat a^ b^ -> EqPRatNc a^ b^)")
(assume "a^" "b^" "EqPab")
(use "EqPab")
;; Proof finished.
;; (cp)
...
;; EqPRatRefl
(set-goal "all a^(TotalRat a^ -> EqPRat a^ a^)")
(assume "a^" "Ta")
(elim "Ta")
;; 3
(assume "k^" "Tk" "p^" "Tp")
...
;; EqPRatSym
(set-goal "all a^,b^(EqPRat a^ b^ -> EqPRat b^ a^)")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
(assume "k^1" "k^2" "EqPk1k2" "p^1" "p^2" "EqPp1p2")
(use "EqPRatRatConstr")
...
;; RatEqTotal
(set-goal "all a^(TotalRat a^ -> all b^(TotalRat b^ -> TotalBoole(a^ =b^)))")
(fold-alltotal)
(cases)
(assume "k" "p")
(fold-alltotal)
...
;; RatPlusEqP
(set-goal "all a^1,b^1(EqPRat a^1 b^1 -> all a^2,b^2(EqPRat a^2 b^2 ->
...
;; RatUMinusEqP
(set-goal "all a^,b^(EqPRat a^ b^ -> EqPRat(~a^)(~b^))")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
...
;; RatUDivEqP
(set-goal "all a^,b^(EqPRat a^ b^ -> EqPRat(RatUDiv a^)(RatUDiv b^))")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
(assume "k^1" "k^2" "EqPIntk1k2" "p^1" "p^2" "EqPp1p2")
(elim "EqPIntk1k2")
...
;; RatAbsEqP
(set-goal "all a^,b^(EqPRat a^ b^ -> EqPRat(abs a^)(abs b^))")
(assume "a^" "b^" "EqPab")
(elim "EqPab")
(assume "k^1" "k^2" "EqPIntk1k2" "p^1" "p^2" "EqPp1p2")
(elim "EqPIntk1k2")
...
(assert "all a,b(a==b -> all k a**k==b**k)")
(assume "a" "b" "a=b")
(cases)
(assume "p")
(use "RatExpCompatPos")
...
;; RatAbsExp
(set-goal "all a,n abs(a**n)=abs a**n")
(assume "a")
(ind)
(use "Truth")
(assume "n" "IH")
...
;; RatExpPosPlus
(set-goal "all a,p,q a**(p+q)==a**q*a**p")
(assume "a" "p" "q")
(simp "PosPlusIntPlus")
(use "RatEqvTrans" (pt "a**(IntPos(NatToPos(PosToNat p))+
                            IntPos(NatToPos(PosToNat q)))"))
;; 4,5
(simp "NatToPosToNatId")
(simp "NatToPosToNatId")
(use "Truth")
...
;; (((a RatExp (NatToInt (PosToNat q)))
;;    RatTimes
;;    (a RatExp (NatToInt (PosToNat p))))
;;   RatEqv
;;   ((a RatExp (IntPos q)) RatTimes (a RatExp (IntPos p))))
(simp "<-" "IntPNatToPosEqNatToInt")
(simp "<-" "IntPNatToPosEqNatToInt")
(simp "NatToPosToNatId")
(simp "NatToPosToNatId")
...
;; RatLeMonExpPosDecr
(set-goal "all a,p,q(0<=a -> a<=1 -> p<=q -> a**q<=a**p)")
(assume "a" "p" "q" "0<=a" "a<=1" "p<=q")
(simp "<-" "PosToNatToIntId")
(simp "<-" "PosToNatToIntId")
(use "RatLeMonExpDecr")
(use "0<=a")
...
;; RatTimesExp
(set-goal "all a,b,n a**n*b**n==(a*b)**n")
(assume "a" "b")
(ind)
;; 3,4
(use "Truth")
...
;; RatTimesInvNat
(set-goal "all n Succ n*(1#NatToPos(Succ n))==1")
(assume "n")
(simp "NatToIntSuccEq")
...
(set-goal "all a(0<=a -> all p 1+p*a<=(1+a)**p)")
(cases)
(cases)
;; 3-5

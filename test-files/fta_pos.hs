...
yprodRec :: ((alpha1, alpha2) -> ((alpha1 -> (alpha2 -> alpha10692)) -> alpha10692))
...
posLeastFactorAux p | even p = (if ((natLeast ((posSqrt ((p `quot` 2) * 2)) + 1) (\ n -> ((1 < n) && (posDiv (if (n) <= 1 then 1 else (n)) ((p `quot` 2) * 2)))))) <= 1 then 1 else ((natLeast ((posSqrt ((p `quot` 2) * 2)) + 1) (\ n -> ((1 < n) && (posDiv (if (n) <= 1 then 1 else (n)) ((p `quot` 2) * 2)))))))
posLeastFactorAux p | odd p = (if ((natLeast ((posSqrt (((p - 1) `quot` 2) * 2 + 1)) + 1) (\ n -> ((1 < n) && (posDiv (if (n) <= 1 then 1 else (n)) (((p - 1) `quot` 2) * 2 + 1)))))) <= 1 then 1 else ((natLeast ((posSqrt (((p - 1) `quot` 2) * 2 + 1)) + 1) (\ n -> ((1 < n) && (posDiv (if (n) <= 1 then 1 else (n)) (((p - 1) `quot` 2) * 2 + 1)))))))

posLeastFactor :: (Pos -> Pos)
posLeastFactor 1 = 1
posLeastFactor p | even p = 2
posLeastFactor p | odd p = (if ((posLeastFactorAux (((p - 1) `quot` 2) * 2 + 1)) == ((posSqrt (((p - 1) `quot` 2) * 2 + 1)) + 1)) then (((p - 1) `quot` 2) * 2 + 1) else (posLeastFactorAux (((p - 1) `quot` 2) * 2 + 1)))

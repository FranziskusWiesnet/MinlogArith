...
;; Case n= Succ...
 ...
 ;; Case m=Succ...
  ...
  (inst-with "PosPrimeToIrred"
	     (pt "qs m") (pt "PosProd Zero n ps") (pt "ps n") "?" "?")
...
(define etermProdSplit (nt (proof-to-extracted-term)))
...
;; (animate-no-nt "PosExPrimeFactorisation")
;; (animate-no-nt "PosPrimeFactorisationsToPms")
;; (animate-no-nt "PosPrimeDivProdPrimesToInPrimes")

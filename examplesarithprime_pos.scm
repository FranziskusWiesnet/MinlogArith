;; 2025-03-23.  examplesarithprime_pos.scm.  Based on Franziskus Wiesnet's
;; div_pos.scm gcd_pos.scm and prime_pos.scm

;; Revised by Franziskus Wiesnet

;; Program constant PosLeastFactorAux PosLeastFactor changed by
;; inserting cases on the form of the argument p.  This will avoid
;; excessive run time when normalizing.  The previous definition now
;; appears as PosLeastFactorAuxLemma.
...
;; (fold-alltotal)
;; (assume "p")
;; (simp "PosLeastFactorAux0CompRule")
;; (use "TotalVar")
;; ;; (cp)
;; (save-totality)
...
;;  (Rec nat=>nat)n2 Zero
;;  ([n3,n4]
;;    [case (PosGcd p1(PosProd Zero n3 ps0)=p1) (True -> n4) (False -> n3)])
...
;;(ppc (nt (proof-to-extracted-term)))

;; cPosPrimeDivProdToDiv
;; Given above
